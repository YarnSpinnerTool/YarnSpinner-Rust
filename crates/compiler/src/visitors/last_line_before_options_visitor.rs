...
use crate::compiler;
use crate::parser::generated::yarnspinnerparser::{BodyContext, Line_statementContext};
use crate::prelude::generated::yarnspinnerparser::{
    BodyContextAttrs, StatementContextAll, StatementContextAttrs, YarnSpinnerParserContextType,
};
...
impl LastLineBeforeOptionsVisitor {
    ...
    fn run_through_statement(&mut self, statements: Vec<Rc<StatementContextAll>>) {
