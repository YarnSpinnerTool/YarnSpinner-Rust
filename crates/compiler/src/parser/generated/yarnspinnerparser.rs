...
impl<'input, I> YarnSpinnerParser<'input, I, DefaultErrorStrategy<'input,YarnSpinnerParserContextType>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for YarnSpinnerParserExt<'input>{
	...
	fn sempred(_localctx: Option<&(dyn YarnSpinnerParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					10 => YarnSpinnerParser::<'input,I,_>::expression_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
impl<'input> DialogueContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DialogueContextAll<'input>> {
		Rc::new(
...
impl<'input> File_hashtagContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<File_hashtagContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<File_hashtagContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			let tmp = recog.base.match_token(HASHTAG_TEXT,&mut recog.err_handler)?;
...
impl<'input> NodeContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NodeContextAll<'input>> {
		Rc::new(
...
impl<'input> HeaderContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<HeaderContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<HeaderContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(HEADER_DELIMITER,&mut recog.err_handler)?;
			...
			if _la==REST_OF_LINE {
				...
				let tmp = recog.base.match_token(REST_OF_LINE,&mut recog.err_handler)?;
...
impl<'input> BodyContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BodyContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<BodyContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << INDENT) | (1usize << SHORTCUT_ARROW) | (1usize << COMMAND_START) | (1usize << EXPRESSION_START) | (1usize << TEXT))) != 0) {
				{
				{
...
impl<'input> StatementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StatementContextAll<'input>> {
		Rc::new(
...
impl<'input> Line_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Line_statementContextAll<'input>> {
		Rc::new(
...
impl<'input> Line_formatted_textContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Line_formatted_textContextAll<'input>> {
		Rc::new(
	...
	-> Result<Rc<Line_formatted_textContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				...
				match recog.base.input.la(1) {
				 ...
				 EXPRESSION_START 
					=> {
						...
						recog.base.match_token(EXPRESSION_START,&mut recog.err_handler)?;
						...
						recog.base.match_token(EXPRESSION_END,&mut recog.err_handler)?;
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !(_la==EXPRESSION_START || _la==TEXT) {break}
			}
			}
			Ok(())
		})();
...
impl<'input> HashtagContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<HashtagContextAll<'input>> {
		Rc::new(
...
impl<'input> Line_conditionContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Line_conditionContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Line_conditionContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_START,&mut recog.err_handler)?;
			...
			recog.base.match_token(COMMAND_END,&mut recog.err_handler)?;
...
impl<'input,'a> Listenable<dyn YarnSpinnerParserListener<'input> + 'a> for ExpressionContextAll<'input>{
    fn enter(&self, listener: &mut (dyn YarnSpinnerParserListener<'input> + 'a)) { self.deref().enter(listener) }
    fn exit(&self, listener: &mut (dyn YarnSpinnerParserListener<'input> + 'a)) { self.deref().exit(listener) }
}
...
impl<'input> ExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExpressionContextAll<'input>> {
		Rc::new(
			...
			match recog.base.input.la(1) {
			 ...
			 OPERATOR_MATHS_SUBTRACTION 
				=> {
					...
					let tmp = recog.base.match_token(OPERATOR_MATHS_SUBTRACTION,&mut recog.err_handler)?;
			 ...
			 OPERATOR_LOGICAL_NOT 
				=> {
					...
					let tmp = recog.base.match_token(OPERATOR_LOGICAL_NOT,&mut recog.err_handler)?;
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(13,&mut recog.base)? {
						1 =>{
							...
							_la = recog.base.input.la(1);
							if { !(((((_la - 49)) & !0x3f) == 0 && ((1usize << (_la - 49)) & ((1usize << (OPERATOR_MATHS_MULTIPLICATION - 49)) | (1usize << (OPERATOR_MATHS_DIVISION - 49)) | (1usize << (OPERATOR_MATHS_MODULUS - 49)))) != 0)) } {
					...
					,
						3 =>{
							...
							ctx.op = recog.base.input.lt(1).cloned(); } else {unreachable!("cant cast");} 
							_la = recog.base.input.la(1);
							if { !(((((_la - 32)) & !0x3f) == 0 && ((1usize << (_la - 32)) & ((1usize << (OPERATOR_LOGICAL_LESS_THAN_EQUALS - 32)) | (1usize << (OPERATOR_LOGICAL_GREATER_THAN_EQUALS - 32)) | (1usize << (OPERATOR_LOGICAL_LESS - 32)) | (1usize << (OPERATOR_LOGICAL_GREATER - 32)))) != 0)) } {
								let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
								if let ExpressionContextAll::ExpComparisonContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
								ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						5 =>{
							...
							ctx.op = recog.base.input.lt(1).cloned(); } else {unreachable!("cant cast");} 
							_la = recog.base.input.la(1);
							if { !(((((_la - 38)) & !0x3f) == 0 && ((1usize << (_la - 38)) & ((1usize << (OPERATOR_LOGICAL_AND - 38)) | (1usize << (OPERATOR_LOGICAL_OR - 38)) | (1usize << (OPERATOR_LOGICAL_XOR - 38)))) != 0)) } {
								let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
								if let ExpressionContextAll::ExpAndOrXorContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
								ctx.op = Some(tmp.clone()); } else {unreachable!("cant cast");}  
...
impl<'input> ValueContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ValueContextAll<'input>> {
		Rc::new(
			...
			match recog.base.input.la(1) {
			 ...
			 KEYWORD_TRUE 
				=> {
					...
					recog.base.match_token(KEYWORD_TRUE,&mut recog.err_handler)?;
			 ...
			 KEYWORD_FALSE 
				=> {
					...
					recog.base.match_token(KEYWORD_FALSE,&mut recog.err_handler)?;
			 ...
			 KEYWORD_NULL 
				=> {
					...
					recog.base.match_token(KEYWORD_NULL,&mut recog.err_handler)?;
...
impl<'input> VariableContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<VariableContextAll<'input>> {
		Rc::new(
...
impl<'input> Function_callContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_callContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Function_callContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << KEYWORD_TRUE) | (1usize << KEYWORD_FALSE) | (1usize << KEYWORD_NULL))) != 0) || ((((_la - 41)) & !0x3f) == 0 && ((1usize << (_la - 41)) & ((1usize << (OPERATOR_LOGICAL_NOT - 41)) | (1usize << (OPERATOR_MATHS_SUBTRACTION - 41)) | (1usize << (LPAREN - 41)) | (1usize << (STRING - 41)) | (1usize << (FUNC_ID - 41)) | (1usize << (VAR_ID - 41)) | (1usize << (NUMBER - 41)))) != 0) {
				{
				/*InvokeRule expression*/
...
impl<'input> If_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<If_statementContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<If_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_ENDIF,&mut recog.err_handler)?;
...
impl<'input> If_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<If_clauseContextAll<'input>> {
		Rc::new(
...
impl<'input> Else_if_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Else_if_clauseContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Else_if_clauseContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_ELSEIF,&mut recog.err_handler)?;
...
impl<'input> Else_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Else_clauseContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Else_clauseContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_ELSE,&mut recog.err_handler)?;
...
impl<'input> Set_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Set_statementContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Set_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_SET,&mut recog.err_handler)?;
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 31)) & !0x3f) == 0 && ((1usize << (_la - 31)) & ((1usize << (OPERATOR_ASSIGNMENT - 31)) | (1usize << (OPERATOR_MATHS_ADDITION_EQUALS - 31)) | (1usize << (OPERATOR_MATHS_SUBTRACTION_EQUALS - 31)) | (1usize << (OPERATOR_MATHS_MULTIPLICATION_EQUALS - 31)) | (1usize << (OPERATOR_MATHS_MODULUS_EQUALS - 31)) | (1usize << (OPERATOR_MATHS_DIVISION_EQUALS - 31)))) != 0)) } {
				let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> Call_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Call_statementContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Call_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_CALL,&mut recog.err_handler)?;
...
impl<'input> Command_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Command_statementContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Command_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_TEXT_END,&mut recog.err_handler)?;
...
impl<'input> Command_formatted_textContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Command_formatted_textContextAll<'input>> {
		Rc::new(
				...
				match recog.base.input.la(1) {
				 COMMAND_TEXT 
					=> {
						...
						recog.base.match_token(COMMAND_TEXT,&mut recog.err_handler)?;
				 ...
				 COMMAND_EXPRESSION_START 
					=> {
						...
						recog.base.match_token(COMMAND_EXPRESSION_START,&mut recog.err_handler)?;
...
impl<'input> Shortcut_option_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Shortcut_option_statementContextAll<'input>> {
		Rc::new(
	...
	-> Result<Rc<Shortcut_option_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			if _la==BLANK_LINE_FOLLOWING_OPTION {
				...
				recog.base.match_token(BLANK_LINE_FOLLOWING_OPTION,&mut recog.err_handler)?;
...
impl<'input> Shortcut_optionContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Shortcut_optionContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Shortcut_optionContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(SHORTCUT_ARROW,&mut recog.err_handler)?;
...
impl<'input> Declare_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Declare_statementContextAll<'input>> {
		Rc::new(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Declare_statementContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMMAND_DECLARE,&mut recog.err_handler)?;
			...
			recog.base.match_token(OPERATOR_ASSIGNMENT,&mut recog.err_handler)?;
			...
			if _la==EXPRESSION_AS {
				...
				recog.base.match_token(EXPRESSION_AS,&mut recog.err_handler)?;

				recog.base.set_state(296);
				let tmp = recog.base.match_token(FUNC_ID,&mut recog.err_handler)?;
				 cast_mut::<_,Declare_statementContext >(&mut _localctx).declaration_type = Some(tmp.clone());
...
impl<'input> Jump_statementContextExt<'input>{
	fn new(parent: Option<Rc<dyn YarnSpinnerParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Jump_statementContextAll<'input>> {
		Rc::new(
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match  recog.interpreter.adaptive_predict(31,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(COMMAND_JUMP,&mut recog.err_handler)?;
