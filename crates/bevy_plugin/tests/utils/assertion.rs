        ...
        app.insert_resource(TriggeredEvents::<PresentLine>(Vec::new()))
            ...
            .add_observer(
                |event: On<PresentLine>,
                 mut triggered_events: ResMut<TriggeredEvents<PresentLine>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<PresentOptions>,
                 mut triggered_events: ResMut<TriggeredEvents<PresentOptions>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<ExecuteCommand>,
                 mut triggered_events: ResMut<TriggeredEvents<ExecuteCommand>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<NodeCompleted>,
                 mut triggered_events: ResMut<TriggeredEvents<NodeCompleted>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<NodeStarted>,
                 mut triggered_events: ResMut<TriggeredEvents<NodeStarted>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<LineHints>, mut triggered_events: ResMut<TriggeredEvents<LineHints>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<DialogueStarted>,
                 mut triggered_events: ResMut<TriggeredEvents<DialogueStarted>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_observer(
                |event: On<DialogueCompleted>,
                 mut triggered_events: ResMut<TriggeredEvents<DialogueCompleted>>| {
                    triggered_events.0.push(event.event().clone());
                },
            )
            .add_systems(
